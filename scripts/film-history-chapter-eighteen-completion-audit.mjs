...
invariant(verificationIds.size === 596, `Global Production Verification registry must contain exactly 596 unique scenarioIds after Annette Chapter 19 materialization: ${verificationIds.size}`);
...
invariant(chapter19.atlas?.baselineFromClosedChapter18 === 539 && chapter19.atlas?.actualCount === 596, "Chapter 19 must preserve the closed 539-scenario Chapter 18 baseline while advancing the current Atlas to 596.");
