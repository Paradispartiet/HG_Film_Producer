...
invariant(verificationIds.size === 599, `Global Production Verification registry must contain exactly 599 unique scenarioIds after Stars at Noon Chapter 19 materialization: ${verificationIds.size}`);
...
invariant(chapter19.atlas?.baselineFromClosedChapter18 === 539 && chapter19.atlas?.actualCount === 599, "Chapter 19 must preserve the closed 539-scenario Chapter 18 baseline while advancing the current Atlas to 599.");
