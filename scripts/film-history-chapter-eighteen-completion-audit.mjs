...
invariant(verificationIds.size === 598, `Global Production Verification registry must contain exactly 598 unique scenarioIds after Nitram Chapter 19 materialization: ${verificationIds.size}`);
