...
if (!item || item.decision !== "USE_EXISTING" || item.scenarioId !== "scenario_the_idiots_1998" || item.productionVerified !== true) throw new Error(`The Idiots did not resolve correctly: ${JSON.stringify(item)}`);
