...
const candidates = [
  ...
  { title: "The 400 Blows", originalTitle: "Les quatre cents coups", year: 1959, aliases: ["Les 400 coups", "The 400 Blows"], role: "missing_core_probe", decisionIfMissing: "P0", chapterFunction: "Truffaut's debut is the indispensable Cahiers-side New Wave case: youth production, Paris locations, a new performer, mobile observation and the industrial break represented by a first feature." },
  { title: "Breathless", originalTitle: "À bout de souffle", year: 1960, aliases: ["A bout de souffle", "Breathless"], role: "missing_core_probe", decisionIfMissing: "P0", chapterFunction: "Godard's first feature tests the most consequential production-language break in the early New Wave: location shooting, small-unit practice, direct address, discontinuous cutting and post-synchronized sound." },
  ...
  { title: "Cléo from 5 to 7", originalTitle: "Cléo de 5 à 7", year: 1962, aliases: ["Cleo from 5 to 7", "Cleo de 5 a 7"], role: "major_comparison", decisionIfMissing: "P1", chapterFunction: "Varda's Paris-time structure is the strongest missing Left Bank/feminist counterweight: urban location work, duration, gendered spectatorship, performance and documentary-fiction observation." },
