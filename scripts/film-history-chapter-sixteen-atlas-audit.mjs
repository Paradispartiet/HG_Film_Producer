...
const candidates = [
  ...
  ["Mephisto", "Mephisto", 1981, [], "anchor_film", "EXISTING_REQUIRED", "Hungarian-West German-Austrian co-production, fascism, performance and Lajos Koltai's verified production system anchor European political cinema."],
  ...
  ["Missing", "Missing", 1982, [], "anchor_film", "EXISTING_REQUIRED", "Costa-Gavras, Universal/PolyGram-era finance, Mexico-for-Chile production and political investigation anchor transnational studio political cinema."],
  ...
  ["Come and See", "Idi i smotri", 1985, ["Idi i smotri"], "anchor_film", "EXISTING_REQUIRED", "Belarusfilm/Mosfilm, large-scale destruction, handheld optics and Soviet war memory anchor state-studio political production."],
