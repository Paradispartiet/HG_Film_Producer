...
const EXPECTED_PLAYABLE_SCENARIOS = 614;
const EXPECTED_VERIFIED_PRODUCTION_CASES = 614;
...
const expansionFiles = [
  ...
  "chapterNineteenTenetExpansion.ts",
  "chapterNineteenSoulExpansion.ts",
  "chapterNineteenWolfwalkersExpansion.ts",
  "chapterNineteenDuneExpansion.ts",
  "chapterNineteenFleeExpansion.ts",
  "chapterNineteenAvatarWayOfWaterExpansion.ts",
  "chapterNineteenNomadlandExpansion.ts",
