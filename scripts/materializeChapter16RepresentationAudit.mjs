...
const reviews = [
  ...
  mapped('scenario_paris_texas_1984', [TRANSNATIONAL], ['src/ui/data/scenarioProductionVerificationParisTexas.ts'], 'The verified case documents European-American financing and production organization around a United States location shoot and international art-cinema circulation, supplying exact transatlantic production-system evidence.'),
  ...
  mapped('scenario_tampopo_1985', [JAPAN], ['src/ui/data/scenarioProductionVerificationJapaneseAuteurCommercialBatch.ts'], 'The production-verified Japanese case adds a later commercial/auteur company and labor configuration to the Japan industry row without treating its mixed genre form alone as sufficient genre-industry evidence.'),
  ...
  mapped('scenario_landscape_in_the_mist_1988', [TRANSNATIONAL], ['src/ui/data/scenarioProductionVerificationLandscapeInTheMist.ts'], 'The verified Greek-European co-production documents cross-border institutional financing and production organization, supplying exact transnational art-cinema system evidence.'),
  ...
  reviewed('scenario_black_rain_1989', 'The production-verified Japanese historical feature is relevant to late-1980s Japanese cinema, but the current review does not establish a distinct additional industrial mechanism needed by the already triangulated Japan row; it is kept reviewed without tokenistic nationality mapping.'),
];
