...
test("all 105 manual scenario production briefs resolve with research-needed status and targets", () => {
  assert.equal(manualScenarioIds.length, 105);
...
test("batch 21 manual briefs keep concise target coverage", () => {
