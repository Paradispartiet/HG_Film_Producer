...
test("all 150 manual scenario production briefs resolve with research-needed status and targets", () => {
  assert.equal(manualScenarioIds.length, 150);
...
test("batch 30 manual briefs keep concise target coverage", () => {
