...
test("all 145 manual scenario production briefs resolve with research-needed status and targets", () => {
  assert.equal(manualScenarioIds.length, 145);
...
test("batch 29 manual briefs keep concise target coverage", () => {
