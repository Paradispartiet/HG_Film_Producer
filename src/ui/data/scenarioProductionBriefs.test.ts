...
test("all 140 manual scenario production briefs resolve with research-needed status and targets", () => {
  assert.equal(manualScenarioIds.length, 140);
...
test("batch 28 manual briefs keep concise target coverage", () => {
