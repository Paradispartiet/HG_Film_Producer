...
test("all 100 manual scenario production briefs resolve with research-needed status and targets", () => {
  assert.equal(manualScenarioIds.length, 100);
...
test("batch 20 manual briefs keep concise target coverage", () => {
