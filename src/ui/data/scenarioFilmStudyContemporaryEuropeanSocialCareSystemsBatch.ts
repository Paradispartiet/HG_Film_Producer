...
const profiles = {
  [toniErdmannFilmHistoryProfile.scenarioId]: toniErdmannFilmHistoryProfile,
  [triangleOfSadnessFilmHistoryProfile.scenarioId]: triangleOfSadnessFilmHistoryProfile,
  [aftersunFilmHistoryProfile.scenarioId]: aftersunFilmHistoryProfile,
  [roomNextDoorFilmHistoryProfile.scenarioId]: roomNextDoorFilmHistoryProfile,
...
export function resolveContemporaryEuropeanSocialCareSystemsFilmStudyMap(
  ...
  const historyProfile = getContemporaryEuropeanSocialCareSystemsFilmHistoryProfile(scenario.id);
