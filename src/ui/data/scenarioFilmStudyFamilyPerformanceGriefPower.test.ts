...
test("family performance, grief and verbal power batch resolves complete source-backed maps", () => {
...
test("family performance, grief and verbal power choices compare three real systems", () => {
  for (const scenarioId of scenarioIds) {
