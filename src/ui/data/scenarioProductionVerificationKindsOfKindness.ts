...
export const kindsOfKindnessProductionCaseVerification = {
  ...
  sources: [
    ...
    {
      title: "Kinds of Kindness' bizarrely realistic sex scene, explained by Yorgos Lanthimos and Jesse Plemons: ‘It was very amateur-ish’",
      publisher: "British GQ",
      url: "https://www.gq-magazine.co.uk/article/kinds-of-kindness-sex-scene",
      sourceKind: "filmmaker_interview",
      supports: ["overall"],
      note: "Direct Lanthimos/Plemons interview supporting an intimacy coordinator on the homemade sex-tape sequence, a reduced set consisting of the director, performers and coordinator, explicit comfort/boundary conversations, and the coordinator's practical contribution to believable staging and performer comfort."
    },
    {
      title: "‘The intimacy co-ordinators are kind of unshockable’: Emma Stone on her new film with Yorgos Lanthimos",
      publisher: "The Irish Times",
      url: "https://www.irishtimes.com/culture/film/2024/06/22/the-intimacy-co-ordinators-are-kind-of-unshockable-emma-stone-on-her-new-even-weirder-film-with-yorgos-lanthimos/",
      sourceKind: "filmmaker_interview",
      supports: ["overall"],
      note: "Direct Stone/Plemons interview independently supporting the coordinator's role in guiding uncomfortable conversations and turning intimate action into explicit movement/choreography rather than leaving boundaries or staging implicit."
    }
  ]
