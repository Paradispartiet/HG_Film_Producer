...
test("American precarity, body and care batch resolves complete source-backed maps", () => {
...
test("American precarity, body and care choices compare three real systems", () => {
  for (const scenarioId of scenarioIds) {
