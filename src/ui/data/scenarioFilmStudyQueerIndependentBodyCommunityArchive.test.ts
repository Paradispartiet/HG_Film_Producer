...
const scenarioIds = [
  "scenario_desert_hearts_1985",
  "scenario_paris_is_burning_1990",
  "scenario_safe_1995",
  "scenario_the_watermelon_woman_1996",
] as const;

test("queer independent body, community and archive batch resolves complete source-backed maps", () => {
...
test("queer independent body, community and archive choices compare three real systems", () => {
  for (const scenarioId of scenarioIds) {
