...
const verificationGroups = [
  ["silent cinema foundations", ["scenario_blacksmith_scene_1893", "scenario_workers_leaving_lumiere_factory_1895", "scenario_grandmas_reading_glass_1900", "scenario_attack_on_a_china_mission_bluejackets_to_the_rescue_1900", "scenario_the_lonely_villa_1909", "scenario_the_story_of_the_kelly_gang_1906", "scenario_queen_elizabeth_1912", "scenario_traffic_in_souls_1913", "scenario_the_corbett_fitzsimmons_fight_1897", "scenario_employees_leaving_browns_atlas_works_sheffield_1901", "scenario_uncle_josh_at_the_moving_picture_show_1902", "scenario_fire_1901", "scenario_life_of_an_american_fireman_1903", "scenario_rescued_by_rover_1905", "scenario_the_great_train_robbery_1903", "scenario_a_trip_to_the_moon_1902", "scenario_the_cabinet_of_dr_caligari_1920", "scenario_nosferatu_1922", "scenario_battleship_potemkin_1925"], 4],
  ...
  ["Antonia's Line feminist family-chronicle system", ["scenario_antonias_line_1995"], 10],
  ["Before Sunrise Vienna dialogue-and-duration system", ["scenario_before_sunrise_1995"], 10],
  ["Clockers Brooklyn photochemical crime system", ["scenario_clockers_1995"], 10],
  ["La Haine banlieue pressure and sound system", ["scenario_la_haine_1995"], 10],
  ["Leaving Las Vegas Super 16 addiction and tragic-romance system", ["scenario_leaving_las_vegas_1995"], 10],
  ["Fargo regional winter neo-noir system", ["scenario_fargo_1996"], 10],
  ["Trainspotting Scottish addiction and music system", ["scenario_trainspotting_1996"], 10],
  ...
  ["Rosetta embodied labour and social-realism system", ["scenario_rosetta_1999"], 10],
  ["The Straight Story chronological Midwestern lawn-mower journey system", ["scenario_the_straight_story_1999"], 10],
  ["Requiem for a Dream addiction body montage system", ["scenario_requiem_for_a_dream_2000"], 10],
  ["The Million Dollar Hotel outsider hotel and music system", ["scenario_the_million_dollar_hotel_2000"], 10],
  ["Amélie Montmartre fairy-tale and miniature-intervention system", ["scenario_amelie_2001"], 10],
  ...
  ["Last Life in the Universe multilingual dreamspace-displacement system", ["scenario_last_life_in_the_universe_2003"], 10],
  ...
  ["The Savages American sibling elder-care system", ["scenario_the_savages_2007"], 10],
  ["Blindness transnational white-blindness sensory-collapse system", ["scenario_blindness_2008"], 10],
  ["Gran Torino Detroit Hmong community and ageing-vigilante revision system", ["scenario_gran_torino_2008"], 10],
  ...
  ["Next four 2012 production systems", ["scenario_in_the_house_2012", "scenario_moonrise_kingdom_2012", "scenario_searching_for_sugar_man_2012", "scenario_the_broken_circle_breakdown_2012"], 4],
  ["The Impossible historical tsunami reconstruction system", ["scenario_the_impossible_2012"], 10],
  ["Blue Jasmine nonlinear class-performance breakdown system", ["scenario_blue_jasmine_2013"], 10],
  ["Her warm near-future voice-intimacy system", ["scenario_her_2013"], 10],
  ["Norte Philippine duration and parallel-guilt system", ["scenario_norte_the_end_of_history_2013"], 10],
  ["Rush 1976 Formula One rivalry reconstruction system", ["scenario_rush_2013"], 10],
  ["Tangerines Abkhazian shelter-and-care chamber war system", ["scenario_tangerines_2013"], 10],
  ["The Great Beauty Roman baroque writer-crisis system", ["scenario_the_great_beauty_2013"], 10],
  ["The Lunchbox Mumbai epistolary delivery-intimacy system", ["scenario_the_lunchbox_2013"], 10],
  ["A Pigeon Sat Living Trilogy studio-tableau system", ["scenario_a_pigeon_sat_on_a_branch_reflecting_on_existence_2014"], 10],
  ["It Follows Detroit walking-curse spatial-dread system", ["scenario_it_follows_2014"], 10],
  ["Leviathan Barents state-church property-expropriation system", ["scenario_leviathan_2014"], 10],
  ["Mommy Quebec square-frame family-pop system", ["scenario_mommy_2014"], 10],
  ["Nightcrawler Los Angeles crime-image market system", ["scenario_nightcrawler_2014"], 10],
  ["45 Years British 35 mm marriage-memory system", ["scenario_45_years_2015"], 10],
  ["Amy archive-led music biography and media-pressure system", ["scenario_amy_2015"], 10],
  ["Anomalisa crowdfunded adult stop-motion and subjective-voice system", ["scenario_anomalisa_2015"], 10],
  ["Brothers eight-year maternal family-documentary system", ["scenario_brothers_2015"], 10],
  ["Dheepan Tamil false-family refugee and siege system", ["scenario_dheepan_2015"], 10],
  ["Drifters Swedish marginal-community survival system", ["scenario_drifters_2015"], 10],
  ...
  ["Land of Mine postwar mine-clearing moral-suspense system", ["scenario_land_of_mine_2015"], 10],
  ["My Skinny Sister child-centred sibling and body-care system", ["scenario_my_skinny_sister_2015"], 10],
  ["Rams Icelandic livestock, weather and brother-conflict system", ["scenario_rams_2015"], 10],
  ...
  ["A Monster Calls child-grief constructed-world and yew-creature system", ["scenario_a_monster_calls_2016"], 10],
  ["Café Society 1930s Hollywood-New York digital period-romance system", ["scenario_cafe_society_2016"], 10],
  ["I, Daniel Blake Newcastle welfare-research social-realism system", ["scenario_i_daniel_blake_2016"], 10],
  ["Manchester by the Sea Cape Ann family-grief memory system", ["scenario_manchester_by_the_sea_2016"], 12],
  ...
  ["Final priority indie systems", ["scenario_ghost_world_2001", "scenario_columbus_2017", "scenario_red_rocket_2021"], 4],
  ...
  ["The Guilty real-time sound-led chamber thriller system", ["scenario_the_guilty_2018"], 6],
