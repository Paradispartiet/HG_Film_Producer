...
const scenarioIds = [
  "scenario_killer_of_sheep_1977",
  "scenario_sex_lies_and_videotape_1989",
  "scenario_slacker_1990",
  "scenario_daughters_of_the_dust_1991",
] as const;

test("American independent breakthroughs resolve complete source-backed maps", () => {
...
test("American independent breakthrough choices compare three real systems", () => {
  for (const scenarioId of scenarioIds) {
