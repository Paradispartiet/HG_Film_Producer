...
const scenarioProductionBriefs: Record<string, ManualScenarioProductionBrief> = {
  ...
  scenario_3_iron_2004: {
    ...
    toneTargets: ["Silent and observant", "Tenderly uneasy", "Silent, weightless and tender"],
  ...
  scenario_into_the_wild_2007: {
    ...
    soundTargets: ["Use music as reflection", "Let nature carry solitude", "Let wind and river swallow speech"],
  ...
  scenario_winter_s_bone_2010: {
    ...
    editingTargets: ["Advance by wary, deliberate steps", "Let encounters reveal risk", "Hold tension after refusals"],
  ...
  scenario_the_pianist_2002: {
    ...
    editingTargets: ["Let survival time pass unhurried", "Let pressure accumulate", "Hold survival moments without rush"],
  ...
  scenario_crash_2004: {
    ...
    toneTargets: ["Tense and confrontational", "Urban and volatile", "Charged with prejudice under the surface"],
  ...
  scenario_the_straight_story_1999: {
    ...
    soundTargets: ["Use music as warmth", "Let natural sound support reflection", "Ride engine hum into night silence"],
  ...
  scenario_the_hunt_2012: {
    ...
    toneTargets: ["Warm community turning watchful", "Civil on the surface, accusatory beneath", "Quietly escalating"],
    screenplayTargets: ["Show trust collapsing through reactions", "Let ordinary life become pressure", "Escalate through exclusion"],
    cinematographyTargets: ["Use restrained realism", "Read the room across glances", "Frame community space as judgment"],
  ...
  scenario_a_somewhat_gentle_man_2010: {
    ...
    toneTargets: ["Grubby deadpan with warmth beneath", "Awkwardly kind", "Quietly violent"],
  ...
  scenario_land_of_mine_2015: {
    ...
    toneTargets: ["Taut discipline over dread", "Physically vulnerable", "Fragilely empathetic"],
  ...
  scenario_45_years_2015: {
    ...
    cinematographyTargets: ["Hold reactions past the point of comfort", "Use domestic space as pressure", "Frame restraint before rupture"],
  ...
  scenario_4_months_3_weeks_and_2_days_2007: {
    ...
    toneTargets: ["Urgent and restrained", "Grim, clenched and unsentimental", "Anxious without relief"],
  ...
  scenario_tangerines_2013: {
    ...
    editingTargets: ["Let the lulls between shellings stretch", "Hold proximity under threat", "Let care shift slowly"],
  ...
  scenario_my_skinny_sister_2015: {
    ...
    toneTargets: ["Quietly anxious", "Tender but uneasy", "Tender surface over quiet alarm"],
  ...
  scenario_cafe_society_2016: {
    ...
    genreTargets: ["Nostalgic Hollywood romance", "Social ambition story", "Bittersweet love triangle"],
  ...
  scenario_i_daniel_blake_2016: {
    ...
    cinematographyTargets: ["Observe practical spaces plainly", "Frame ordinary institutions as pressure", "Frame institutions at eye level"],
    editingTargets: ["Cut to the rhythm of queues and holds", "Let forms create obstacles", "Hold small humiliations"],
  ...
  scenario_on_body_and_soul_2017: {
    ...
    toneTargets: ["Hushed, dreamlike and tentative", "Lonely but hopeful", "Ordinary with dream logic"],
  ...
  scenario_virgin_mountain_2015: {
    ...
    cinematographyTargets: ["Observe stillness softly", "Give the big man room in the frame", "Frame routines as shelter"],
  ...
  scenario_blindness_2008: {
    ...
    toneTargets: ["Disorienting and fearful", "Fragile order sliding into squalor", "Uncertain and tense"],
  ...
  scenario_dog_day_afternoon_1975: {
    ...
    editingTargets: ["Escalate through negotiation", "Let the standoff idle until nerves fray", "Track attention as pressure"],
  ...
  scenario_manhattan_1979: {
    ...
    genreTargets: ["Urban romance of ideas", "Urban relationship story", "Self-image character comedy"],
  ...
  scenario_bicycle_thieves_1948: {
    ...
    toneTargets: ["Plainspoken and urgent", "Dignified under poverty", "Worn dignity under economic strain"],
  ...
  scenario_vertigo_1958: {
    ...
    screenplayTargets: ["Let obsession rebuild a person as an image", "Turn pursuit into a trap", "Link desire to illusion"],
    ...
    learningGoals: ["Thriller form can make desire and perception unreliable", "Twist the mystery by revealing it early", "Spiral the camera into obsession"],
    verificationStatus: "needs_research"
  },
  ...
  scenario_fargo_1996: {
    ...
    toneTargets: ["Chipper politeness over cold violence", "Absurd but dangerous", "Plainspoken under threat"],
