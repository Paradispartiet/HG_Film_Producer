...
const profiles = {
  ...
  [fjolsTilFjellsFilmHistoryProfile.scenarioId]: fjolsTilFjellsFilmHistoryProfile,
  [deDodesTjernFilmHistoryProfile.scenarioId]: deDodesTjernFilmHistoryProfile,
  [insomniaFilmHistoryProfile.scenarioId]: insomniaFilmHistoryProfile,
...
export function resolveNorwegianPostwarGenreSystemsFilmStudyMap(
  ...
  const historyProfile = getNorwegianPostwarGenreSystemsFilmHistoryProfile(scenario.id);
