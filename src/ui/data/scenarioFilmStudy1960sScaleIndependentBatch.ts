...
import { spaceOdysseyFilmHistoryProfile } from "./scenarioFilmStudy1960s2001";
import { lawrenceOfArabiaFilmHistoryProfile } from "./scenarioFilmStudy1960sLawrenceOfArabia";
import { nightOfTheLivingDeadFilmHistoryProfile } from "./scenarioFilmStudy1960sNightOfTheLivingDead";
import { psychoFilmHistoryProfile } from "./scenarioFilmStudy1960sPsycho";

const profiles = {
  [psychoFilmHistoryProfile.scenarioId]: psychoFilmHistoryProfile,
  [lawrenceOfArabiaFilmHistoryProfile.scenarioId]: lawrenceOfArabiaFilmHistoryProfile,
  [spaceOdysseyFilmHistoryProfile.scenarioId]: spaceOdysseyFilmHistoryProfile,
  [nightOfTheLivingDeadFilmHistoryProfile.scenarioId]: nightOfTheLivingDeadFilmHistoryProfile,
...
export function get1960sScaleIndependentFilmHistoryProfile(scenarioId: string): FilmHistoryProfile | undefined {
  return profiles[scenarioId as keyof typeof profiles];
}

export function resolve1960sScaleIndependentFilmStudyMap(
  scenario: FilmScenarioSeed,
  brief: ScenarioProductionBrief,
): ScenarioFilmStudyMap | undefined {
  const historyProfile = get1960sScaleIndependentFilmHistoryProfile(scenario.id);
...
export function create1960sScaleIndependentFilmHistoryChoices(profile: FilmHistoryProfile): readonly FilmHistoryChoice[] {
  ...
  return [
    {
      ...
      quality: "match",
      feedback: "This matches the documented relationship between the film's 1960s production conditions, scale and specific craft system.",
    },
    ...(near ? [{
      id: `${profile.scenarioId}-history-partial`,
      label: `${near.period}: ${near.moment}`,
      quality: "partial" as const,
      feedback: "This is a real 1960s production system, but it organizes resources, image, performance, editing, effects and sound differently.",
    }] : []),
    ...(far ? [{
      id: `${profile.scenarioId}-history-miss`,
      label: `${far.period}: ${far.moment}`,
      quality: "miss" as const,
      feedback: "This assigns the film to the wrong production scale, institutional context and craft logic.",
    }] : []),
  ];
}
