...
test("Japanese ambiguity and dialogue batch resolves complete source-backed maps", () => {
...
test("Japanese ambiguity and dialogue choices compare three real systems", () => {
  for (const scenarioId of scenarioIds) {
    ...
    assert.ok(choices.slice(1).every((choice) => choice.label.includes("Japanese")));
  }
});
