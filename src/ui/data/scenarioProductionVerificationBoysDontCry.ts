  ...
  sources: [
    {
      ...
      supports: ["overall", "screenplay", "directing", "cinematography", "editing"],
    ...
    },
    {
      ...
      sourceKind: "contemporaneous_press",
      supports: ["overall"],
    ...
    },
    {
      ...
      sourceKind: "university_film_notes",
      supports: ["overall"],
