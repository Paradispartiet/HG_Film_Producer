...
const profiles = {
  ...
  [doubleLifeOfVeroniqueFilmHistoryProfile.scenarioId]: doubleLifeOfVeroniqueFilmHistoryProfile,
...
export function resolveEuropeanPoeticMemorySystemsFilmStudyMap(
  ...
  const historyProfile = getEuropeanPoeticMemorySystemsFilmHistoryProfile(scenario.id);
