...
export function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <footer><span>HG Film Producer</span><span>{view === "dev" ? "Demo inspection" : view === "scenarios" ? "Stable Production Cases MVP" : "Experimental Studio Career branch"}</span></footer>
    </div>
  );
}
