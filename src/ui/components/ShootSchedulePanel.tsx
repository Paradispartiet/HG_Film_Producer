...
export function ShootSchedulePanel({ preparation, result }: ShootSchedulePanelProps) {
  ...
  return (
    <section className="shoot-desk-section">
      <div className="shoot-section-heading">
        <div><span className="eyebrow">Production schedule</span><h3>First shoot day</h3></div>
