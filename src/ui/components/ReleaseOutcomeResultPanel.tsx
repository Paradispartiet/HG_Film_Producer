...
interface ReleaseOutcomeResultPanelProps { readonly evaluation: ReleaseOutcomeEvaluation; readonly strategyScore: ReleaseStrategyScore; }

export function ReleaseOutcomeResultPanel({ evaluation, strategyScore }: ReleaseOutcomeResultPanelProps) {
  const scores = [
  ...
  return (
    <section className="release-outcome-panel">
      <div className="release-outcome-hero"><div><span className="eyebrow">Final release evaluation</span><h3>Film released</h3><p>The release is resolved. Applying this result to the studio and career is the next future step.</p></div><div className="release-overall"><span>Overall</span><strong>{evaluation.overall}</strong><small>/100</small></div></div>
