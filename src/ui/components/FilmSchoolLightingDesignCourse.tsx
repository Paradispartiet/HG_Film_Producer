    ...
    <div className="filmverket-shell school-course-shell school-lighting-design-course-shell">
      ...
      <main className="film-school-course-page">
        ...
        <section className={mastered ? "school-final-assignment is-unlocked" : "school-final-assignment"}>
          <div><span className="filmverket-kicker">{chrome.finalAssignment}</span><h2>Fra sceneintensjon til samlet look-system</h2><p>Planlegg én scene der lyskilder, kontrast, palett, produksjonsdesign og visuell kontinuitet følger samme dramatiske utvikling. Oppgaven åpnes i Film Director med fem leveransefelt.</p></div>
          <aside>
      ...
      <footer className="filmverket-footer"><span>{chrome.productBrand} · Film School</span><span>Kilde → kontrast → palett → rom → kontinuitet</span></footer>
    </div>
  );
}
