...
export const chapterEighteenAttackOfTheClonesExpansionDefinitions = [
  {
    ...
    phases: [
      ...
      { id: "ilm_pipeline", label: "Move more than 2,000 effects shots through a digital pipeline", player_task: "Coordinate more than 2,000 effects shots across live action, miniatures, digital characters, compositing and reviews while keeping capture, VFX and color timing as distinct stages with their own owners and failure modes." },
