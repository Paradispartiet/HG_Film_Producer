...
test("Chapter 8 audit locks the reviewed French avant-garde Production Case matrix", () => {
  ...
  assert.match(audit, /USE_EXISTING: \["Cœur fidèle", "Napoléon", "The Passion of Joan of Arc", "Un Chien Andalou", "Entr'acte", "The Smiling Madame Beudet"\]/);
  ...
  assert.deepEqual(resolved.byDecision.USE_EXISTING, ["The Passion of Joan of Arc", "Cœur fidèle", "Napoléon", "Un Chien Andalou", "The Smiling Madame Beudet", "Entr'acte"]);
