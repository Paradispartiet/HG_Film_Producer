...
test("capture Brazil integration files", () => {
  ...
  constructed = replaceOnce(constructed, "const constructedWorldsProfiles = {", "const coreConstructedWorldsProfiles = {", "core profile map");
  constructed = replaceOnce(
    constructed,
  ...
  registry = replaceOnce(registry, "  ...constructedWorldsVerificationRecords,", "  ...constructedWorldsVerificationRecords,\n  ...brazilVerificationRecords,", "Brazil verification spread");
  ...
  verificationTest = replaceOnce(verificationTest, "const expectedVerifiedCount = 258;", "const expectedVerifiedCount = 259;", "verified count");
