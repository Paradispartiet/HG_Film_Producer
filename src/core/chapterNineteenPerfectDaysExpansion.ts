...
export const chapterNineteenPerfectDaysExpansionDefinitions = [
  {
    ...
    requiredChoicesSeed: {
      ...
      chronology: ["film_year_2023", "production_year_2023", "principal_photography_october_2022", "wenders_filmportal_sixteen_days", "franz_lustig_seventeen_days", "shoot_duration_16_vs_17_days_discrepancy", "exact_daily_schedule_unresolved"],
