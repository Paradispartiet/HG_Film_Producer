...
export const chapterSevenWeimarExpansionDefinitions = [
  ...
  },
  {
    ...
    phases: [
      ...
      { id: "research", label: "Nero-Film, Wedekind and version research", player_task: "Ground Nebenzahl, Pabst, Vajda, Brooks, Krampf, Andrejew, Heš, Staaken production, Südfilm distribution and later version history in institutional evidence." },
