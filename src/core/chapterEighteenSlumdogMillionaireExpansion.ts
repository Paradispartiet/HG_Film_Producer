...
export const chapterEighteenSlumdogMillionaireExpansionDefinitions = [
  {
    ...
    phases: [
      ...
      { id: "format_map", label: "Assign SI-2K and 35mm by scene requirement", player_task: "Use the mobile digital rig where access and movement drive the shot, preserve 35mm where night/image conditions require it, and track every source format for post." },
