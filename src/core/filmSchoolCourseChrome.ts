...
export type FilmSchoolCourseChrome = {
  ...
  readonly sectionLabels: Readonly<Record<FilmverketSection, string>>;
...
export const FILM_SCHOOL_COURSE_CHROME: Record<FilmWorkLanguage, FilmSchoolCourseChrome> = {
  en: {
    productBrand: "FilmWork", productMonogram: "FW", navAria: "FilmWork sections",
    sectionLabels: { home: "Front page", producer: "Film Producer", atlas: "Film Atlas", director: "Film Director", school: "Film School", history: "Film History", research: "Research" },
    foundation: "Directing foundations", module: "Module", modules: "modules", courseProgress: "Course progress", terms: "technical terms", filmExamples: "film examples", finalAssignment: "final directing assignment", resetCourse: "Reset course", resetConfirm: "Reset all progress and notes in this course?", coursePath: "Course path",
  ...
  nb: {
    productBrand: "Filmverket", productMonogram: "FV", navAria: "Filmverket-seksjoner",
    sectionLabels: { home: "Forside", producer: "Filmprodusent", atlas: "Filmatlas", director: "Filmregissør", school: "Filmskole", history: "Filmhistorie", research: "Forskning" },
    foundation: "Regi grunnkurs", module: "Modul", modules: "moduler", courseProgress: "Kursprogresjon", terms: "fagbegreper", filmExamples: "filmeksempler", finalAssignment: "avsluttende regioppgave", resetCourse: "Nullstill kurs", resetConfirm: "Nullstill all progresjon og alle notater i dette kurset?", coursePath: "Kursløp",
  ...
  fr: {
    productBrand: "FilmWork", productMonogram: "FW", navAria: "Sections FilmWork",
    sectionLabels: { home: "Accueil", producer: "Production", atlas: "Atlas du film", director: "Réalisation", school: "École de cinéma", history: "Histoire du cinéma", research: "Recherche" },
  ...
  pt: {
    productBrand: "FilmWork", productMonogram: "FW", navAria: "Secções do FilmWork",
    sectionLabels: { home: "Início", producer: "Produção", atlas: "Atlas de cinema", director: "Realização", school: "Escola de cinema", history: "História do cinema", research: "Investigação" },
