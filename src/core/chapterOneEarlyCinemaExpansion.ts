...
export const chapterOneEarlyCinemaExpansionDefinitions = [
  ...
  },
  {
    ...
    aliases: ["Workers Leaving the Lumiere Factory", "La Sortie de l'Usine Lumière à Lyon", "La Sortie des usines Lumière", "Sortie d'usine"],
    year: 1895,
  ...
  {
    id: "scenario_life_of_an_american_fireman_1903",
    ...
    tradition: "Early Edison fire-rescue narrative and pre-1908 scene-based temporal construction",
    tone: "Procedural, spectacular and rescue-driven",
    premise: "Build a fire-rescue production that joins large fire-service spectacle to staged mother-and-child drama while preserving the original inside-then-outside rescue order documented by the copyright paper print.",
    screenplay: "Progress from fireman's life and alarm through brigade response to the rescue, treating the original final interior rescue and repeated exterior rescue as two complete scene units rather than later intercut fragments.",
    image: "Combine large fire-department action, apparatus and fixed rescue viewpoints so the production scale is legible without pretending the real fire-service material makes the story documentary.",
    editing: "Preserve Porter's original scene-based temporal construction: complete the rescue inside, then replay it outside. Keep any later cross-cut reconstruction explicitly separate from the canonical Production Case.",
    sound: "Treat the photographed production as silent and keep later accompaniment separate from the original 1903 evidence.",
    learning: "Use Life of an American Fireman to understand both early multi-shot narrative production and the historiographic danger of teaching a later re-edit as if it were the original film.",
    sourceId: "manual_life_of_an_american_fireman_1903",
    sourceUrl: "https://www.loc.gov/static/programs/national-film-preservation-board/film-registry/descriptions.html",
    scenarioType: "action_adventure_production",
    requiredChoicesSeed: {
      screenplay: ["fire_service_to_rescue", "scene_based_temporality", "inside_then_outside_repetition"],
      camera: ["fire_department_scale", "fixed_rescue_viewpoints", "interior_exterior_space"],
      editing: ["original_paper_print_order", "inside_then_outside", "reject_later_crosscut_reedit"],
      sound: ["silent_capture", "later_accompaniment_separation"],
      themes: ["film_history", "rescue_spectacle", "version_history", "preservation_evidence"],
    },
    learningGoals: [
      "Reconstruct the original rescue order from paper-print evidence instead of the later modernizing cross-cut re-edit.",
      "Connect Edison fire-department logistics, staged drama and scene-based editing without retrofitting later continuity grammar.",
    ],
    phases: [
      { id: "pitch", label: "Pitch", player_task: "Define the fire-service spectacle and rescue drama without assuming modern cross-cutting." },
      { id: "research", label: "Research", player_task: "Use preservation evidence to distinguish Porter's original version from the later re-edit." },
      { id: "screenplay", label: "Screenplay", player_task: "Order fire-service life, alarm, response and rescue as historically specific scene units." },
      { id: "casting", label: "Casting", player_task: "Coordinate mother, child, firefighter roles and large fire-service participation so each action remains readable." },
      { id: "production_design", label: "Production design", player_task: "Build the rescue environment around firehouse apparatus, burning-building space and practical emergency action." },
      { id: "cinematography", label: "Cinematography", player_task: "Choose fixed viewpoints that separately explain interior and exterior rescue space." },
      { id: "editing", label: "Editing", player_task: "Complete the interior rescue before repeating it outside; reject the later cross-cut re-edit as original evidence." },
      { id: "sound", label: "Sound", player_task: "Keep original silent production distinct from later accompaniment." },
      { id: "release", label: "Release", player_task: "Explain the 1903 Edison case and its later preservation controversy without rewriting film history around the re-edit." },
    ],
  },
  {
