...
export const chapterEighteenASeparationExpansionDefinitions = [
  {
    ...
    phases: [
      ...
      { id: "court_rebuild", label: "Recreate inaccessible court spaces inside two disused schools", player_task: "Build the judge's office and court material inside two disused schools while preserving the cramped institutional behavior and spatial logic the screenplay needs." },
      ...
      { id: "music_restraint", label: "Withhold score until the closing credits", player_task: "Keep dramatic scenes free of non-diegetic music in line with Farhadi's stated resistance to emotional judgment, then introduce the credited music only over the closing credits at the version boundary." },
