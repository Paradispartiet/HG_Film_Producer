...
const exactExisting = [
  "The Gleaners and I", "Platform", "Dancer in the Dark", "In the Mood for Love", "Yi Yi", "Atanarjuat: The Fast Runner", "Spirited Away", "The Son's Room", "Millennium Mambo", "Russian Ark", "City of God", "Star Wars: Episode II - Attack of the Clones", "Lost in Translation", "The Return", "Collateral", "Tropical Malady",
...
const exactP1Queue = [
  "Crouching Tiger, Hidden Dragon", "28 Days Later", "Unknown Pleasures", "Oldboy", "Brokeback Mountain", "Caché",
...
test("Chapter 18 audit locks the 2000–2019 digital-convergence scope", () => {
  ...
  assert.equal(resolved.verificationIndex.literalVerifiedScenarioIds, 516);
});
...
test("Chapter 18 locks the exact evidence-derived Production Case queues", () => {
  ...
  assert.equal(exactExisting.length, 59);
